...
#############################################################################################################################
# Login system of Smart medicine dispenser
...
class Login:
    ...
    def set_info_label(self, frame, text, x, y, fg='red', bg='white'):
        self.infoLabel = Label(frame, text=text, font=('optima', 10), fg=fg,
                               bg=bg)
    ...
    def login_page(self):
        ...
        slot1 = Label(self.entrySlots, text="Username/Email", font=(ENTRY_FONT, ENTRY_FONT_SIZE, 'bold'), fg='orangered', bg='white')
        slot1.place(x=55, y=110)

        slot2 = Label(self.entrySlots, text="Password", font=(ENTRY_FONT, ENTRY_FONT_SIZE, 'bold'), fg='orangered', bg='white')
        ...
        self.role = ttk.Combobox(self.entrySlots, width="8", values=("Doctor", "Patient"), background='white')
        ...
        registerBtn = Button(self.entrySlots, command=self.register_page, text="Don't have an account? Sign Up",
                             font=('calibri', 12), cursor="hand2", bg='white', fg='black', borderwidth=3) #mac
        registerBtn.place(x=90, y=370) # mac
    ...
    def register_page(self):
        ...
        slot1 = Label(self.reg_entrys, text="Username", font=(ENTRY_FONT, ENTRY_FONT_SIZE, 'bold'), fg='orangered', bg='white')
        slot1.place(x=35, y=110)

        slot2 = Label(self.reg_entrys, text="Password", font=(ENTRY_FONT, ENTRY_FONT_SIZE, 'bold'), fg='orangered', bg='white')
        slot2.place(x=35, y=210)

        slot3 = Label(self.reg_entrys, text="Email", font=(ENTRY_FONT, ENTRY_FONT_SIZE, 'bold'), fg='orangered', bg='white')
        slot3.place(x=300, y=110)

        slot4 = Label(self.reg_entrys, text="Confirm Password", font=(ENTRY_FONT, ENTRY_FONT_SIZE, 'bold'), fg='orangered', bg='white')
        ...
        Label(self.reg_entrys, text="You're a ", font=(ENTRY_FONT, ENTRY_FONT_SIZE, 'bold'), fg='orangered', bg='white').place(x=300,
                                                                                                                y=70)
        self.registerRole = ttk.Combobox(self.reg_entrys, width="12", values=("Doctor", "Patient"), background='white')#mac
        self.registerRole.place(x=400, y=80) #mac
